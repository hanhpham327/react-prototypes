...
class Stopwatch extends Component {
    ...
    start(){
        this.setState({
            ...
            //when the state is start it wil have getting the new date / get time function
        });
    ...
    render(){
        ...
        return (
            <div className='jumbotron'>
                ...
                <hr className='my-3'/>
                {/* the first elapsed has to match the format_time variable,
                 and  {elapsed}..is the constant variable */}
